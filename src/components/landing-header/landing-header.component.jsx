...
const LandingHeader = () => {
 ...
 text-[#fff] text-[16px] md:text-[20px] xl:text-[24px] font-bold rounded-xl tracking-tighter shadow-[0_30px_80px_-10px_rgba(255,215,0,0.5),_0_-30px_80px_-10px_rgba(255,215,0,0.5)] mt-12 mb-6 cursor-pointer"
        ...
        <p className="text-center text-[30px] md:text-[60px] xl:text-[80px] font-bold w-full md:w-[668px] xl:w-[768px] leading-[1] tracking-tighter mb-6 ">
          Build Your Career with{" "}
          <span className="text-[#1342ff]">Hello Dreams AI</span>
        </p>
        <p className="w-full md:w-[696px] text-[16px] md:text-[20px] text-[#eaecf0] text-center">
