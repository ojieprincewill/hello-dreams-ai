        ...
        {isGenerating ? (
          <div className="text-center">
            ...
            <p className="text-sm text-[#667085] dark:text-gray-400 mb-6">
              Our AI is tailoring your resume and writing a cover letter
            ...
            <div className="space-y-3">
              {steps.map((step, i) => (
                <div key={i} className="flex items-center gap-3">
                  <div
                    className="w-6 h-6 rounded-full bg-[#f0f4ff] dark:bg-[#1a2040] flex items-center justify-center shrink-0 animate-pulse"
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-[#667085] dark:text-gray-400 mb-6">
              Your tailored resume and cover letter have been generated. You can
              now apply!
            </p>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-3 p-3 rounded-xl bg-[#f9f9f9] dark:bg-[#2a2a2a]">
                ...
                <div className="text-left">
                  <p className="text-sm font-medium text-[#010413] dark:text-white">
                    Tailored Resume
                  </p>
                  <p className="text-xs text-[#667085] dark:text-gray-400">
                    Optimised for this role
                  </p>
                </div>
